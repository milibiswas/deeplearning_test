...
class data_loader_messey(object):
    ...
    def __init__(self,SourceDatasetPath="../data/dataset/messeydataset",pathTestDataSource="../test/dataset/messeydataset"):
        ...
        self.train_transform = Compose([Resize([224,224]),RandomHorizontalFlip(0.2),ToTensor(),Normalize(mean=(0.485,0.456,0.406),std=(0.229,0.224,0.225))])
        self.simple_transform = Compose([Resize([224,224]),ToTensor(),Normalize(mean=(0.485,0.456,0.406),std=(0.229,0.224,0.225))])
